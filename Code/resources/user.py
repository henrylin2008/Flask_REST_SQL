...
class UserLogin(Resource):
	...
	def post(cls):
		...
		# check password, same as security.authenticate() function used to do
		...
		# create access token
		# create refresh token (look at it later)
		# return item
...
class UserLogout(Resource):
	@jwt_required
	def post(self):
		jti = get_raw_jwt()['jti'] #jti is 'JWT ID', a unique id for a JWT
		BLACKLIST.add(jti)
